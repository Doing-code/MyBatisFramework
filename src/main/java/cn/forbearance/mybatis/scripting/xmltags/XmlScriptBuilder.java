...
public class XmlScriptBuilder extends BaseBuilder {
    ...
    private interface NodeHandler {
        void handleNode(Element nodeToHandler, List<SqlNode> targetContents);
    }

    /**
     * <trim prefix="where" prefixOverrides="AND | OR" suffixOverrides="and">...</trim> 解析 trim 标签信息，
     * 把字段 prefix、 prefixOverrides、suffixOverrides 都依次获取出来，
     * 使用 TrimSqlNode 构建后存放到 List<SqlNode>
     */
     ...
     * 获取标签配置 test 语句表达式，
     * 使用 IfSqlNode 进行构建，构建后存放到 List<SqlNode>
     */
