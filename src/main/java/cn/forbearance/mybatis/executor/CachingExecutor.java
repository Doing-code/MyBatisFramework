...
import cn.forbearance.mybatis.cache.TransactionalCacheManager;
...
public class CachingExecutor implements Executor {
    private final Logger log = LoggerFactory.getLogger(CachingExecutor.class);
    ...
    public <E> List<E> query(MappedStatement ms, Object parameter, RowBounds rowBounds, ResultHandler resultHandler, BoundSql boundSql, CacheKey key) throws SQLException {
        ...
        if (cache != null) {
            ...
            if (ms.isUseCache() && resultHandler == null) {
                ...
                if (list == null) {
                    list = delegate.<E>query(ms, parameter, rowBounds, null, boundSql, key);
                    // cache：缓存队列实现类，FIFO
