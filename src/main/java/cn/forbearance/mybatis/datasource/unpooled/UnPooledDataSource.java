...
public class UnPooledDataSource implements DataSource {
    ...
    /**
     * 驱动【mysql：com.mysql.jdbc.driver】
     */
    ...
    /**
     * 通过调用DriverManager.getDrivers()方法获取当前调用者，可以访问的所有已加载的JDBC驱动程序
     * 并将其注册在registeredDrivers中。其实就是通过jdk提供的spi机制获取META-INF/service包下注册的所有实现类。
     * 这里Enumeration的实际类型为LazyIterator类
     */
    static {
